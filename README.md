...
This is an `$ ls` abstarction programm that is usefull when we want to `ls` in a directory where all files share the same prefix and have a suffix that numerically differs.
